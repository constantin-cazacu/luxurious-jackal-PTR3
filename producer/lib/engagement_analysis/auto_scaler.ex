defmodule EngagementAnalysis.AutoScaler do
  use GenServer
  require Logger

  def start_link() do
    Logger.info("Starting Engagement Auto-Scaler", ansi_color: :yellow)
    count_tweets = 0
  ...
  def handle_info(:work, count_tweets) do
    ...
    if rem(count_tweets, 4) > 0 do
      ...
      active_workers = DynamicSupervisor.count_children(EngagementAnalysis.PoolSupervisor).active
