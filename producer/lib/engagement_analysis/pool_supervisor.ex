defmodule EngagementAnalysis.PoolSupervisor do
  ...
  def child_spec(index) do
    %{
      id: EngagementWorker,
      start: {EngagementAnalysis.Worker, :start_link, [System.unique_integer([:positive, :monotonic])]}
    }
  end
  ...
  def start_worker(auto_scaler_nr) do
    ...
    case auto_scaler_nr do
      auto_scaler_nr when (auto_scaler_nr > 0) ->
        ...
        EngagementAnalysis.LoadBalancer.send_worker_pid(worker_pid)
